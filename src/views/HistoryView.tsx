...
export const HistoryView: React.FC = () => {
  ...
  return (
    <div className="bg-card rounded shadow-sm border border-light-border p-8 max-w-4xl mx-auto mt-10">
              ...
              {sessions.map((s) => (
                <tr key={s.session_id} className="border-b border-light-border hover:bg-muted">
                  ...
                  <td className="py-3 px-4">
                    <span className="bg-input-bg border border-orange-border px-2 py-1 rounded-full text-xs text-primary-text">
                      {s.status}
                    </span>
                  </td>
                  <td className="py-3 px-4 text-sm text-secondary-text">
