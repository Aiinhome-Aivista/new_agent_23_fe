...
export const LandingView: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-card backdrop-blur-md border-b border-light-border px-4 py-2 shadow-xs">
                <div className="max-w-7xl mx-auto flex justify-between items-center gap-1">
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
                        ...
                        <div className="flex flex-col items-start gap-1">
                            <span className="font-logo-title text-primary-orange leading-tight">Unit-Test Case Generator Agent</span>
                            <Badge variant="outline" className="text-[10px] bg-input text-primary-orange font-mono font-bold px-2 py-0 rounded border border-orange-border">
                                v1.0 Enterprise
                            </Badge>
                        </div>
                    </div>
                        ...
                        {isAuthenticated ? (
                            <div className="flex items-center gap-3">
                                <span className="text-xs text-secondary-text font-mono hidden sm:inline-block">
                                    Logged in as <br /><strong className="text-primary-orange">{user?.name}</strong>
                                </span>
                                <Button
                                    onClick={() => navigate('/new-session')}
                                    rightIcon={<ArrowRight className="w-4 h-4" />}
                                    className="shadow-xs text-xs py-2 px-4"
                                >
                                    Launch Workspace
                                </Button>
                            </div>
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-14">
                        <Button
                            ...
                            className="text-sm px-8 shadow-md transform hover:-translate-y-0.5"
                        >
                            Start Test Case Generation Now
                        </Button>
                        <Button
                            variant="outline"
                            size="lg"
                            onClick={() => navigate('/login')}
                            leftIcon={<Users className="w-4 h-4 text-primary-orange" />}
                            className="font-semibold text-sm px-6 shadow-xs"
                        >
                            Try Demo Login
                        </Button>
                    </div>
            ...
            <section className="py-12 px-6 max-w-5xl mx-auto">
                <div className="bg-gradient-to-r from-orange-500/90 to-amber-500/90 backdrop-blur-sm rounded-2xl p-8 sm:p-10 text-center shadow-lg text-primary-foreground">
                    ...
                    <Button
                        ...
                        className="font-bold text-xs px-8 shadow-sm text-primary-orange bg-card hover:bg-muted"
                    >
